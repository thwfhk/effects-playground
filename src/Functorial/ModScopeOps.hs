...
pCandy :: ( Signature f g, In Once g, In Or f
            , In (Throw ()) f, In (Catch ()) g)
         => Prog f g Int
pCandy = catch (once (or (return 1) (throw ()))) (\() -> return 2)

candy1 = hdlNdThenEx pCandy -- hND
candy2 = hdlNdThenEx'' pCandy -- hNDLT'
-- >>> candy1
-- Right [2]
-- >>> candy2
-- Right [1]
